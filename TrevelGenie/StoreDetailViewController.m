...
- (void)viewDidLoad
{
    ...
    tit = self.StoreList.title;
    
    NSArray *modelsAsArray = [self.StoreList.description componentsSeparatedByString:@"||"];
    
    

    NSString *desc = [modelsAsArray objectAtIndex:2];
    NSString *imgem = [modelsAsArray objectAtIndex:3];
    NSString *rate = [modelsAsArray objectAtIndex:4];
    NSString *email = [modelsAsArray objectAtIndex:5];
    webim = [modelsAsArray objectAtIndex:9];
    phone = [modelsAsArray objectAtIndex:6];
    mailim = [modelsAsArray objectAtIndex:5];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    vc.description = self.StoreList.description;
